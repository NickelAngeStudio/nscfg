...
#
# USAGE
# $  Must be called by nscfg_tests.sh with no arguments.
#
# NOTE
# 
#
...
# T29~T30 NSCFGError::WildcardArmOnTarget error.
...
# T32~T33 NSCFGError::TargetInFunction error.
...
#T40-T42 NSCFGError::MixedSyntaxError
...
echo "nscfg_release_modifier_behaviour = { value = \"ignore\", force = true }" >> .cargo/config.toml
